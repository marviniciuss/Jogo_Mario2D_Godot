...
@onready var music_background = $music_background
@onready var musica_shooting = $MusicaShooting
...
func die():
	if player_mode == PlayerMode.small:
		...
		#death_tween.tween_callback(func(): get_tree().change_scene_to_file("res://Cenas/game_over.tscn")) # Altera para a cena de Game Over
		#death_tween.tween_callback(func(): get_tree().reload_current_scene())
		# Store the current scene before changing to Game Over
		var current_scene_path = get_tree().current_scene.get_path()
		# Pass this path to the Game Over scene
		var game_over_scene = preload("res://Cenas/game_over.tscn").instantiate()
		game_over_scene.set("scene_to_restart", current_scene_path)
